...
typedef struct CUetblSmDisableMask_st {
    ...
    CUresult (CUDAAPI *cuStreamSetDisableMask)(CUstream hStream,
                                               unsigned int smDisableMaskUpper,
                                               unsigned int smDisableMaskLower);

    // Set the valid sm disable mask globally
    CUresult (CUDAAPI *cuGlobalSetDisableMask)(unsigned int smDisableMaskUpper,
                                               unsigned int smDisableMaskLower);
    ...
    CUresult (CUDAAPI *cuSetTpcSelMask)(unsigned int *qmdTpcSelMask,
                                        unsigned int numGPC);
