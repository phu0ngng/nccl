...
#ifndef __cuda_etbl_tools_common_qmd_h__
#define __cuda_etbl_tools_common_qmd_h__

#ifdef __cplusplus
extern "C" {
#endif // __cplusplus

// Refer- https://p4viewer.nvidia.com/get/hw/nvgpu/class/mfs/class/compute/kepler_compute.mfs
...
// Refer- https://p4viewer.nvidia.com/get/hw/nvgpu/class/mfs/class/compute/pascal_compute.mfs
typedef struct CUtoolsQMDV02_01_st
{
    /* DWORDS 0, 1
        OuterPut                        :31
        OuterOverflow                   :1
    ...
    */
    ...
    /* DWORD 4
        QmdGroupId                      :6
        SMGlobalCachingEnable           :1
        RunCtaInOneSMPartition          :1
        IsQueue                         :1
        AddToHeadOfQmdGroupLinkedList   :1
        SemaphoreReleaseEnable0         :1
        SemaphoreReleaseEnable1         :1
    ...
    */
    ...
    /* DWORD 30
        ...
        RegisterCount                   :8
    */
    NvU32 ShaderLocalMemoryHighSizeAndRegisterCount;

    /* DWORD 31
        ShaderLocalMemoryCrsSize        :24
        SassVersion                     :8
    */
    NvU32 ShaderLocalMemoryCrsSizeAndSassVersion;
    ...
    /* DWORDS 32 ... 47
        ...
        ConstantBufferReservedAddr[i]   :6
        ConstantBufferInvalidate[i]     :1
        ConstantBufferSizeShifted4[i]   :17
    */
    NvU32 ConstantBuffer[16];
    ...
    */
    ...
    /* DWORD 52 */
    NvU32 HwOnlySpanListHeadIndex;

    /* DWORD 53 */
    NvU32 HwOnlySkedNextQmdPointer;
...
// Refer- https://p4viewer.nvidia.com/get/hw/nvgpu/class/mfs/class/compute/volta_compute.mfs
typedef struct CUtoolsQMDV02_02_st
{
    /* DWORDS 0, 1
    OuterPut                        :31
    OuterOverflow                   :1
    ...
    */
    ...
    /* DWORD 17
    SharedMemorySize                :18
    MinSmConfigSharedMemSize        :7
    MaxSmConfigSharedMemSize        :7
    */
    NvU32 SharedMemorySize;
    ...
    */
    ...
    ConstantBufferValid[8]          :8
    RegisterCountV                  :9
    TargetSmConfigSharedMemSize     :7
    FreeCtaSlotsEmptySm             :8
    */
    NvU32 ConstBuffersValid;
    ...
    */
    ...
    /* DWORD 48 .. 49
    ProgramAddressLower             :32
    ProgramAddressUpper             :17
    QmdReservedS                    :15
    */
    NvU64 ProgramAddress64;
