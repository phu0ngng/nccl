...
- [DGX Spark Multi-Node Ring Subnet-Aware Routing](items/id_EAF70414/DGX_Spark_Multi-Node_Ring_Subnet-Aware_Routing.md)
...
- [Rings and Tree rework for DGX H100](items/23/Rings_and_Tree_rework_for_DGX_H100.md)
- [Dynamic GID Detection in IB RoCE networks](items/24/Dynamic_GID_Detection_in_IB_RoCE_networks.md)
<!-- V2_21_DO_NOT_MOVE -->
...
- [InfiniBand Port Fusion](items/21/InfiniBand_Port_Fusion.md)
- [User buffer registration for send recv operations](items/22/User_buffer_registration_for_send_recv_operations.md)
<!-- V2_20_DO_NOT_MOVE -->
...
- [Network Device Plugins](items/20/Network_Device_Plugins.md)
<!-- V2_19_DO_NOT_MOVE -->
...
- [Communicator Split](items/19/Communicator_Split.md)
<!-- V2_18_DO_NOT_MOVE -->
...
- [Fault Tolerance NCCL](items/18/Fault_Tolerance_NCCL.md)
<!-- V2_14_DO_NOT_MOVE -->
...
- [Enqueue Refactor for CUDA Graphs](items/17/Enqueue_Refactor_for_CUDA_Graphs.md)
<!-- INCOMPLETE - [NVML init-time memoization](items/16/NVML_init-time_memoization.md) -->
<!-- V2_13_DO_NOT_MOVE -->
...
- [One hop nvlink network communication (PXN)](items/15/One_hop_nvlink_network_communication.md)
<!-- V2_12_DO_NOT_MOVE -->
...
- [Prescale Sum](items/12/Prescale_Sum.md)
- [User buffer registration](items/14/User_buffer_registration.md)
<!-- V2_11_DO_NOT_MOVE -->
...
- [Channel split for point-to-point communication](items/8/Channel_split_for_point-to-point_communication.md)
- [Shared buffers for network communication](items/9/Shared_buffers_for_network_communication.md)
- [Indirect NVLink communication (NVB)](items/10/Indirect_NVLink_communication.md)
<!-- V2_8_DO_NOT_MOVE -->
...
- [Point to point communication](items/7/Point_to_point_communication.md)
<!-- V2_7_DO_NOT_MOVE -->
...
- [LL128](items/5/LL128.md)
- [Topology Graph](items/6/Topology_Graph.md)
<!-- V2_5_DO_NOT_MOVE -->
...
- [Tree algorithms](items/4/Tree_algorithms.md)
<!-- V2_4_DO_NOT_MOVE -->
...
- [Direct algorithms (canceled)](items/3/Direct_algorithms.md)
<!-- V2_3_DO_NOT_MOVE -->
...
- [Aggregated Collectives](items/1/Aggregated_Collectives.md)
<!-- V2_2_DO_NOT_MOVE -->
