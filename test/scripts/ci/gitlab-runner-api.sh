...
if [[ ${DEVICE_API} -eq 0 ]] ; then
  gtestFilter="${gtestFilter}:ncclCommQueryProperties_test.test_gin_support:ncclCommQueryProperties_test.test_railed_gin_support:ncclCommQueryProperties_test.test_multimem_support:ncclCommWindowRegister_test.*"
fi
