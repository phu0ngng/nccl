...
__hidden ncclResult_t pluginGetProperties(int dev, ncclNetProperties_v10_t* props) { return ncclSuccess; }
__hidden ncclResult_t pluginListen(int dev, void* handle, void** listenComm) { return ncclInternalError; }
__hidden ncclResult_t pluginConnect(int dev, ncclNetCommConfig_v10_t* config, void* handle, void** sendComm, ncclNetDeviceHandle_t** sendDevComm) { return ncclInternalError; }
...
__hidden ncclResult_t pluginMakeVDevice(int* d, ncclNetVDeviceProps_v10_t* props) { return ncclInternalError; }
