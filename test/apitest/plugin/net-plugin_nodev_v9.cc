...
__hidden ncclResult_t pluginGetProperties(int dev, ncclNetProperties_v9_t* props) { return ncclSuccess; }
...
extern "C" __attribute__((visibility("default"))) const ncclNet_v9_t ncclNetPlugin_v9 = {
