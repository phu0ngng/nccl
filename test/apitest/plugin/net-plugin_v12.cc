...
__hidden ncclResult_t pluginMakeVDevice(int* d, ncclNetVDeviceProps_v12_t* props) {
  return ncclSuccess;
}
...
__hidden ncclResult_t pluginSetNetAttr(void* ctx, ncclNetAttr_v12_t* netAttr) {
  return ncclSuccess;
}
