...
__hidden ncclResult_t pluginListen_v10(int dev, void* handle, void** listenComm) { return ncclInternalError; }
...
__hidden ncclResult_t pluginAccept_v10(void* listenComm, void** recvComm, ncclNetDeviceHandle_v10_t** recvDevComm) { return ncclInternalError; }
...
__hidden ncclResult_t pluginInit_v8(ncclDebugLogger_t logFunction) {
  return pluginInit_v10(logFunction, NULL);
}
...
__hidden ncclResult_t pluginIrecv_v8(void* recvComm, int n, void** data, int* sizes, int* tags, void** mhandles, void** request) {
  ...
  return pluginIrecv(recvComm, n, data, sizesOut, tags, mhandles, NULL, request);
}
