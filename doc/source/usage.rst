...
1. Install the NCCL library on your system (see Downloading NCCL)
2. Modify your application to link to that library
3. Include the header file nccl.h in your application
4. Create a communicator (see Creating a Communicator)
5. Familiarize yourself with the NCCL API documentation to maximize your usage performance. For more information, see the NCCL API documentation.  
