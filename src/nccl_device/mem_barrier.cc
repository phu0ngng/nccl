...
NCCL_API_CXX(ncclResult_t, ncclLsaBarrierCreateRequirement, ncclTeam team, int nBarriers, ncclLsaBarrierHandle* outHandle, ncclSymResourceRequirements* outReq);
