...
#define NCCL_LL128_MAX_NTHREADS NCCL_MAX_NTHREADS
#define NCCL_LL128_ELEMS_PER_THREAD 64
...
#define NCCL_LL128_SHMEM_SIZE (32768/sizeof(uint64_t))
#define NCCL_LL128_SHMEM_ELEMS_PER_THREAD (NCCL_LL128_SHMEM_SIZE/NCCL_LL128_MAX_NTHREADS)
