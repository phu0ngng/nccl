...
#define DECL5(func, algo, proto, devredop, type) \
  ...
  extern __global__ void NCCL_KERN_NAME(func, algo, proto, devredop, type)(struct ncclDevComm* comm, uint64_t channelMask, uint16_t inlineFuncIx, struct ncclWorkElem inlineWorkElem, struct ncclWork* workHead); \
