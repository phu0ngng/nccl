...
static ncclResult_t collNetIallreduce(void* collComm, void* sendData, void* recvData, int count, ncclDataType_t dataType, ncclRedOp_t redOp, int type, void** request) {
  NCCLCHECK(collNet->iallreduce(collComm, sendData, recvData, count, dataType, redOp, type, request)); return ncclSuccess; }
