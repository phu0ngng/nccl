...
static ncclResult_t collNetIallreduce(void* collComm, void* sendData, void* recvData, int count, ncclDataType_t dtype, ncclRedOp_t redOp, int type, void** request) {
  NCCLCHECK(collNet->iallreduce(collComm, sendData, recvData, count, dtype, redOp, type, request)); return ncclSuccess; }
