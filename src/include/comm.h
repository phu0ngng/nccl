...
// Channels / LL tuning
#define NCCL_LL_THREAD_THRESHOLD 64
...
struct ncclComm {
  ...
  int latencies[NCCL_NUM_FUNCTIONS][NCCL_NUM_ALGORITHMS][NCCL_NUM_PROTOCOLS];
  int bandwidths[NCCL_NUM_FUNCTIONS][NCCL_NUM_ALGORITHMS][NCCL_NUM_PROTOCOLS];
