...
__device__ __forceinline__ void ReduceCopyMulti(const int w, const int nw, const int t,
    FUNC fn, bool preOp, bool postOp, int nsrcs, const T** s, int ndsts, T** d, const int elemOffset, const Int Nelem
  ) {
...
__device__ __forceinline__ void ReduceCopy128bMulti(const int w, const int nw, const int t,
    FUNC fn, bool preOp, bool postOp, int nsrcs, const T** s, int ndsts, T** d, const int elemOffset, const Int Npack
  ) {
  const Int inc = nw * UNROLL * WARP_SIZE;
  Int offset = w * UNROLL * WARP_SIZE + t;
...
__device__ __forceinline__ void ReduceOrCopyMulti(
    const int tid, const int nthreads, FUNC fn, bool preOp, bool postOp, int nsrcs, const T** srcs, int ndsts, T** dsts, Int N
  ) {
  Int Nrem = N;
  if (Nrem <= 0) return;
  ...
  if (align == 0) {
    ...
    ReduceCopy128bMulti<FUNC, T, UNROLL, MINSRCS, MAXSRCS, MINDSTS, MAXDSTS, PreOpN>
      (w, nw, t, fn, preOp, postOp, nsrcs, srcs, ndsts, dsts, offset, Npack);
  ...
  ReduceCopyMulti<FUNC, T, UNROLL*PACKELEMS/2, MINSRCS, MAXSRCS, MINDSTS, MAXDSTS, PreOpN>
    (w, nw, t, fn, preOp, postOp, nsrcs, srcs, ndsts, dsts, offset, Nelem);
  ...
  ReduceCopyMulti<FUNC, T, 1, MINSRCS, MAXSRCS, MINDSTS, MAXDSTS, PreOpN>
    (w, nw, t, fn, preOp, postOp, nsrcs, srcs, ndsts, dsts, offset, Nrem);
}
